...
svg#welcome-animation {
    ...
    #cogs-group {
        ...
        animation: closeCogs .2s 5s linear forwards; 
        @keyframes closeCogs {
    ...
    #logo-p {
        ...
        animation-delay: 5.2s, 6s, 7s, 12.4s;
    ...
    #curly-right {
        ...
        animation-delay: 5s, 6s, 7s, 12.4s;
    ...
    #logo-dash { 
        ...
        animation-delay: 7.2s, 12.3s; 
    }
    #logo-k { 
        transform-origin: 50% 50%;
        animation-delay: 7.3s, 12.2s; 
    }
    #logo-i { 
        transform-origin: 63% 50%; 
        animation-delay: 7.4s, 12.1s;
    }
    #logo-n { 
        transform-origin: 75% 50%; 
        animation-delay: 7.5s, 12.0s;
    }    
    @keyframes spinIn {
...
.frontend-development {
    ...
    animation: textOut .7s 11.5s ease forwards;
    @keyframes textOut {
